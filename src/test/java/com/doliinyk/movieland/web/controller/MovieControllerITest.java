...
public class MovieControllerITest {
    ...
    public void getAll() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/v1/movie?rating=desc"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
                .andExpect(jsonPath("$", hasSize(3)))
                .andExpect(jsonPath("$[0].id", is(3)))
                .andExpect(jsonPath("$[0].nameRussian", is("Фильм3")))
                .andExpect(jsonPath("$[0].nameNative", is("Movie3")))
                .andExpect(jsonPath("$[0].yearOfRelease", is(2000)))
                .andExpect(jsonPath("$[0].picturePath", is("picture3.png")))
                .andExpect(jsonPath("$[0].rating", is(9.9)))
                ...
                .andExpect(jsonPath("$[2].nameRussian", is("Фильм1")))
                .andExpect(jsonPath("$[2].nameNative", is("Movie1")))
                .andExpect(jsonPath("$[2].yearOfRelease", is(1998)))
                .andExpect(jsonPath("$[2].picturePath", is("picture1.jpg")))
                .andExpect(jsonPath("$[2].rating", is(8.9)))
